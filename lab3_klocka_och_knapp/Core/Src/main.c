...
void uart_print_menu()
{
	...
	HAL_UART_Transmit(&huart2, "Choose an option: \n", 20, 100);
	HAL_UART_Transmit(&huart2, "1. Clock mode.\n", 16, 100);
	HAL_UART_Transmit(&huart2, "2. Button mode.\n", 16, 100);
}


void uart_print_bad_choice()
{
	HAL_UART_Transmit(&huart2, "Wrong input\n", 11, 100);
}
